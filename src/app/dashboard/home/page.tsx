...
export default function HomePage() {
  ...
  // Recently created (last 5 by createdAt)
  const recentPosts = [...posts]
    .sort((a, b) => new Date(b.createdAt).getTime() - new Date(a.createdAt).getTime())
    .slice(0, 5);

  // Coming up (next 14 days from March 22 2026)
  ...
  return (
    <div style={{ padding: '32px', maxWidth: '1200px' }}>
        ...
        {platformStats.map((stat) => (
          ...
          >
            <div style={{ display: 'flex', alignItems: 'center', gap: '8px', marginBottom: '12px' }}>
              ...
              />
              <span style={{ color: '#AAAAAA', fontSize: '13px' }}>{stat.platform}</span>
            </div>
            <div style={{ display: 'flex', alignItems: 'flex-end', justifyContent: 'space-between' }}>
              <div>
                <div style={{ fontSize: '26px', fontWeight: 700, color: '#FFFFFF', lineHeight: '1' }}>
                  {stat.value}
                </div>
      ...
      <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: '16px', marginBottom: '24px' }}>
        ...
        >
          <h2 style={{ fontSize: '14px', fontWeight: 600, color: '#FFFFFF', margin: '0 0 16px 0' }}>
            Content Pipeline
          </h2>
          ...
          {upcomingPosts.length === 0 ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '10px' }}>
              {upcomingPosts.map((post) => (
                ...
                >
                  <CalendarDays size={13} color="#555555" style={{ flexShrink: 0 }} />
          ...
          {lastTwoNews.length === 0 ? (
            ...
            <div style={{ display: 'flex', flexDirection: 'column', gap: '12px' }}>
              {lastTwoNews.map((item) => (
                ...
                >
                  <div style={{ fontSize: '12px', color: '#888888', marginBottom: '3px' }}>
